...
void HAL_ADC_ConvCpltCallback(ADC_HandleTypeDef *hadc)
{
	...
	joystick[gimbalsFlipped == 0 ? 3 : 2] = (
	    ...
	    channel[0] = (uint16_t)expoYaw[((map(joystick[2],(joystickMin[1][0] + 100) + trim[0], (joystickMax[1][0] - 100) + trim[0], 0, 1023) ) & 0x07FF)]; // Roll
	    channel[1] = (uint16_t)expoYaw[((map(joystick[3],(joystickMin[1][1] + 100) + trim[1], (joystickMax[1][1] - 100) + trim[1], 1023, 0) ) & 0x07FF)]; // Pitch
